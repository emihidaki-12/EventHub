...
-- 5. OTP tokens table (2FA via email)
...
-- ============================================================
--  If upgrading an existing deployment, run these manually:
--
--  CREATE TABLE IF NOT EXISTS otp_tokens (
--    id         INT AUTO_INCREMENT PRIMARY KEY,
--    user_id    INT NOT NULL,
...
--
--  If upgrading an existing deployment, run these manually (attendance):
--
--  ALTER TABLE events
--    ADD COLUMN status ENUM('active','postponed','cancelled')
